...
class BasePostprocessor(object):
    ...
    def generate_gt_bbx(self, data_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            #print('projected_object_bbx_corner: ', projected_object_bbx_corner)
            # MY_CODE
            visible_gt_object_ids_dict[cav_id] = object_ids.copy()
        ...
        #print('object_id_tensor: ', object_id_tensor)
        #print('gt_box3d_tensor: ', gt_box3d_tensor)

        # MY_CODE
        # filter mask visible_gt_object_ids_dict
        # only keep id also in final overall gt ids
        object_id_list = object_id_tensor.tolist()
        ...
        for cav_id in data_dict:
          visible_gt_object_ids_dict[cav_id] = [object_id for object_id in visible_gt_object_ids_dict[cav_id] if object_id in object_id_list]  
          invisible_gt_object_ids_dict[cav_id] = [object_id for object_id in object_id_list if object_id not in visible_gt_object_ids_dict[cav_id]]
        # generate invisible_gt_object_ids_dict
        #print('visible_gt_object_ids_dict: ', visible_gt_object_ids_dict)
        #print('invisible_gt_object_ids_dict: ', invisible_gt_object_ids_dict)
        #assert False

        return gt_box3d_tensor, object_id_tensor, visible_gt_object_ids_dict, invisible_gt_object_ids_dict
