...
class VoxelPostprocessor(BasePostprocessor):
    ...
    def post_process_return_in_dict(self, data_dict, output_dict):
        ...
        # Store full BEV features
        spatial_features_dict = {}
        spatial_features_2d_dict = {}
        regression_map_dict = {}
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            # Store full BEV features
            spatial_features_dict[cav_id] = output_dict[cav_id]['spatial_features']
            spatial_features_2d_dict[cav_id] = output_dict[cav_id]['spatial_features_2d']
            regression_map_dict[cav_id] = output_dict[cav_id]['rm']
            classification_map_dict[cav_id] = output_dict[cav_id]['psm']
        ...
        #print('spatial_features_dict.keys(): ', spatial_features_dict.keys())
        #print("spatial_features_dict['ego'].shape: ", spatial_features_dict['ego'].shape)
        #print("spatial_features_dict['1'].shape: ", spatial_features_dict['1'].shape)
        # [1, 64, 200, 352]
        #print("spatial_features_2d_dict['ego'].shape: ", spatial_features_2d_dict['ego'].shape)
        #print("spatial_features_2d_dict['1'].shape: ", spatial_features_2d_dict['1'].shape)
        # [1, 256, 50, 88]
        return pred_box_dict, pred_score_dict, pred_feature_dict, pred_early_feature_dict, spatial_features_dict, spatial_features_2d_dict, regression_map_dict, classification_map_dict
