...
MODEL="v2vllmq3_10ep_both_shallow_f1"
...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ../DMSTrack/V2V4Real/official_models/train_no_fusion_keep_all/npy/co_llm/v2v4real_3d_grounding_qa_dataset_v2vllmq3.json \
